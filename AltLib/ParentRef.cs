...
{
    /// <summary>
    /// A reference to something in the parent branch.
    /// </summary>
    public class ParentRef : AltRef
    {
        /// <summary>
        /// Creates a new instance of <see cref="ParentRef"/>
        /// </summary>
        ...
        public ParentRef(uint sequence, uint item = 0, string propertyName = "")
